...
class _SignUpPageState extends State<SignUpPage> {
    ...
    try {
      ...
      if (newUser.user != null) {
        ...
        await userDoc.set({
          ...
          'email': _emailController.text.trim(),
          'password': _passwordController.text.trim(),
          'created_at': FieldValue.serverTimestamp(), // Add creation time
          'user_type': 'user', // Assign user_type here
        });
  ...
  void navigateToAdminSignUp() {
    Navigator.of(context).pushReplacementNamed('/admin_signup');
  }
